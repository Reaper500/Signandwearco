...
const testimonials = [
  {
    ...
    role: 'CEO',
    content: 'Signex helped us transform our business strategy and achieve 300% growth in just one year. Their expertise and guidance were invaluable.',
    rating: 5,
  },
  {
    name: 'Michael Chen',
    ...
    role: 'Founder',
    content: 'The consultation services provided by Signex gave us clarity and direction. We now have a clear path to success and the tools to achieve it.',
    rating: 5,
  },
  {
    ...
    role: 'Director',
    content: 'Working with Signex was a game-changer. Their strategic insights helped us reposition our brand and reach new markets effectively.',
    rating: 5,
  },
]
